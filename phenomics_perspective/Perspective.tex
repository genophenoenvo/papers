...
\hypersetup{breaklinks=true,
  ...
  \href{mailto:rbartelme@arizona.edu}{\nolinkurl{rbartelme@arizona.edu}}} (University of Arizona) and Michael Behrisch (Utrecht University) and Emily J Cain (University of Arizona) and Remco Chang (Tufts University) and Ishita Debnath (Michigan State University) and P. Bryan Heidorn (University of Arizona) and Pankaj Jaiswal (Oregon State University) and David S LeBauer (University of Arizona) and Ab Mosca (Tufts University) and Monica Munoz-Torres (Oregon State University) and Arun Ross (Michigan State University) and Kent Shefchek (Oregon State University) and Tyson L Swetnam (University of Arizona) and Anne E Thessen (Oregon State University)},
...
granularity and terminology
\citep{mungallintegrating2010, stuckyplant2018} facilitate data
integration at scales beyond a single taxon or single ecosystem. In
addition, as the data sets and questions become more complicated, more
non-linear predictive models are needed to address them.
...
The ordering of authors following first is alphabetical with senior
author last, contributions included: conceptualization (c), editing (e),
review (r), and text writing (w). RPB: cew, MB: c, EC: cr, RC: c, ID: c,
PBH: c, PJ: c, DSL: cerw, AM: c, MMT: cerw, AR: c, KS: c, TLS: cerw,
AET: cerw.
