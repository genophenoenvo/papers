...
shaped by non-linear multiscale effects that are difficult to
disentangle into discrete components. Advances in the fields of
ontolgoies, unsupervised learning, and genomics are currently disparate.
The interoperability of these different data schema is difficult.
However, here we present a framework utilizing phenotypic data,
knoweldge graphing, and deep learning, to better link phenotypes,
