...
author:
- name: Ryan P Bartelme^[Corresponding Author, rbartelme@email.arizona.edu]
...
The ordering of authors following RPB is alphabetical, contributions included: conceptualization (c), editing (e), review (r), and text writing (w). 
